    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="author" class="col-sm-3 control-label">Penulis</label>
                ...
                <div class="form-group">
                    <label for="publisher" class="col-sm-3 control-label">Penerbit</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              		<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Ubah Buku</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_title" class="col-sm-3 control-label">Judul</label>
                ...
                <div class="form-group">
                    <label for="edit_author" class="col-sm-3 control-label">Penulis</label>
                ...
                <div class="form-group">
                    <label for="edit_publisher" class="col-sm-3 control-label">Penerbit</label>
